...
import ITguysworking from './backgroundpics/ITguysworking.jpg'; // Import the background image
...
const MovingOctagons1 = () => {
  ...
  const initialPositions = [
    { ...getRandomPosition(maxWidth, maxHeight), text: 'DWH', color: '#AEC6CF' }, // Light blue
    { ...getRandomPosition(maxWidth, maxHeight), text: 'ML/Time Series Forecasting', color: '#FFB347' }, // Light orange
    { ...getRandomPosition(maxWidth, maxHeight), text: 'ICT Invoicing', color: '#B39EB5' }, // Light purple
    { ...getRandomPosition(maxWidth, maxHeight), text: 'LLM/Narrative Reporting', color: '#FF6961' }, // Light red
    { ...getRandomPosition(maxWidth, maxHeight), text: 'Custom Apps Low/No code', color: '#AEC6CF' }, // Light blue
    { ...getRandomPosition(maxWidth, maxHeight), text: 'DWH', color: '#CFCFC4' }, // Light grey
  ];
  ...
  return (
    <div
      ...
      style={{ 
        backgroundImage: `url(${ITguysworking})`, 
...
export default MovingOctagons1;
